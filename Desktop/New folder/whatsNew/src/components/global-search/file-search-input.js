...
} from "../../store/actionTypes/folder-action-types";
...
const FileSearchInput = (props) => {
  ...
  useEffect(() => {
    ...
    setDiscussionId(searchObject?.discussion?.id ? searchObject.discussion.id : "");
  ...
  const renderSuggestion = (suggestion, { query }) => {
    ...
    if (props.channelId !== undefined) {
      suggestionText = `${suggestion.length > 64
        ? `${suggestion.substring(0, 64)}...`
        : suggestion
        }`;
    } else {
      suggestionText = `${suggestion.length > 100
                        ...
                        <div className="folder-content">
                          ...
                          >
                            <DiscussionListSuggestions
                              ...
                              className={`member-add-input form-control ${submitted &&
                                (discussion === ""
                                  ? "is-invalid"
                              ...
                              // )}
                              value={
                                discussion.name ? discussion.name : discussion
                              }
                            />
                            <p
                              style={{
                        ...
                        <div className="folder-content">
                          ...
                          >
                            <FolderListSuggestions
                              ...
                              className={`folder-input form-control  ${submitted &&
                                (folder === ""
                                  ? "is-invalid"
                                  : folderId === undefined
                                    ? "is-invalid"
                            ...
                            >
                              {!folderFound && (
                                <div
                                  ...
                                  className="invalid-feedback"
                                >
                                  {t("file.forward:error.folder.not.found")}
                                </div>
                              )}
                            </p>
                          </div>
                      ...
                      <div className="start-date-content">
                        ...
                        >
                          <DatePicker
                            ...
                            className={`form-control ${submitted && dateIsInvalid ? "is-invalid" : ""
                              }`}
                          />
                        </div>
                      </div>
