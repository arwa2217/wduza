...
var Trigger = function (_Component) {
  ...
  _createClass(Trigger, [{
    ...
    value: function _getProps() {
      ...
      var props = (_props2 = {}, _defineProperty(_props2, tag === 'button' ? 'type' : 'role', 'button'), _defineProperty(_props2, 'tabIndex', disabled ? '' : 0), _defineProperty(_props2, 'aria-disabled', disabled), _defineProperty(_props2, 'onKeyDown', this._handleKeyDown), _props2);
...
Trigger.defaultProps = {
  ...
  keybindings: ['Enter', ' ', 'ArrowUp', 'ArrowDown'],
  triggerOn: ['click'],
